Public Class list_cli
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If RadioButton1.Checked = True Then
            Me.ClientesTableAdapter.FillByid(Me.Db_papDataSet.Clientes, TextBox1.Text)
        
        ElseIf RadioButton3.Checked = True Then
            Me.ClientesTableAdapter.FillBynif(Me.Db_papDataSet.Clientes, TextBox1.Text)

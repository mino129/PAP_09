Public Class op_cli
    ...
    Private Sub search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles search.Click
        Me.ClientesTableAdapter.FillBysearchcliu(Me.Db_papDataSet.Clientes, NomeTextBox.Text)
    End Sub
    ...
    Private Sub deletenome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deletenome.Click
        ...
        If answer = DialogResult.Yes Then
            Dim a As Integer = Me.ClientesTableAdapter.deletebynome(txtdelete.Text)
            If a = 1 Then
    ...
    Private Sub deleteid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deleteid.Click
        ...
        If answer = DialogResult.Yes Then
            Dim x As Integer = Me.ClientesTableAdapter.deletebyid(txtdelete.Text)
            If x = 1 Then
                MsgBox("O registo foi eliminado com sucesso")
            Else
    ...
    Private Sub update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles update.Click
        Me.ClientesTableAdapter.FillBysearchcliu(Me.Db_papDataSet.Clientes, updatetext.Text)
        save.Visible = True
        ID_CliTextBox.Visible = False
        ...
        '  MsgBox(updatetext.Text)
        'Me.ClientesTableAdapter.FillBysearchnome(Me.Db_papDataSet.Clientes, updatetext.Text)
    ...
    Private Sub save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles save.Click
        ...
        If (NomeTextBox.Text = "" Or RuaTextBox.Text = "" Or CidadeTextBox.Text = "" Or Cod_PostalTextBox.Text = "") Then
            MsgBox("Por favor preencha todas as caixas de texto")
        Else
            Me.ClientesTableAdapter.updatecli(NomeTextBox.Text, NifTextBox.Text, RuaTextBox.Text, Cod_PostalTextBox.Text, PaisTextBox.Text, Cod_PostalTextBox.Text, TelefoneTextBox.Text, E_MailTextBox.Text, ID_CliTextBox.Text)
            ID_CliTextBox.Visible = True
            NifTextBox.Clear()
            PaisTextBox.SelectedIndex = -1
            NomeTextBox.Clear()
            RuaTextBox.Clear()
